...
import com.example.uasapplaporan.ui.history.HistoryActivity;
import com.example.uasapplaporan.ui.report.ReportActivity;
import com.example.uasapplaporan.utils.Constant;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void setInitLayout() {
        ...
        cvHistory.setOnClickListener(v -> {
            strTitle = "Riwayat Laporan Anda";
            Intent intent = new Intent(MainActivity2.this, HistoryActivity.class);
            intent.putExtra(HistoryActivity.ACTIVITY_SERVICE, strTitle);
            startActivity(intent);
        });
    }
